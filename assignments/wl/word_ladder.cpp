 ...
 * */
void filterDissimilarWords(std::unordered_set<std::string> &words,
...
getWordMap(const std::unordered_set<std::string> &words,
           const std::string &word);
...
constructHops(const std::string &to,
              const std::unordered_map<std::string, int> &depths, int minHops);

/*
 * calculate and return a vector of hops for given word dictionary
 */
std::vector<std::unordered_set<std::string>>
getHops(std::unordered_set<std::string> &words, const std::string &from,
        const std::string &to);
 ...
 */
std::vector<std::vector<std::string>> constructLadders(
...
void filterReverseHops(std::vector<std::unordered_set<std::string>> &hops) {
  ...
  for (std::reverse_iterator fromHops = hops.rbegin();
       (fromHops + 1) != hops.rend(); ++fromHops) {
...
constructHops(const std::string &to,
  ...
  std::vector<std::unordered_set<std::string>> hops(
      minHops, std::unordered_set<std::string>{});
